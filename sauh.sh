...
██████╔╝ ██║  ██║╚█████╔╝██║  ██║
╚═════╝  ╚═╝  ╚═╝ ╚════╝ ╚═╝  ╚═╝v4
  Coded by Dithin+ community
  github: https://github.com/ithiz
...
echo -e "\033[47;3;35m Go to your browser / change proxy to 127.0.0.1:9050\033[0m"
sleep 8
python3 install.py
aut
	...
	clear
        echo -e '\033[36;40;1m Wrong code entered'	
	sleep 1
	clear 
	bash sauh.sh
fi
